...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleCandidatureNotFound(CandidatureNotFoundException ex) {
        ...
        ProblemDetail problem = ProblemDetail.forStatusAndDetail(HttpStatus.NOT_FOUND, ex.getMessage());
        problem.setType(URI.create(PROBLEM_BASE_URI + "candidature-not-found"));
        problem.setTitle("Candidature Not Found");
        problem.setProperty("timestamp", Instant.now());
        return problem;
    }

    @ExceptionHandler(InvalidProjectOperationException.class)
    public ProblemDetail handleInvalidProjectOperation(InvalidProjectOperationException ex) {
        log.warn("Invalid project operation: {}", ex.getMessage());
        ProblemDetail problem = ProblemDetail.forStatusAndDetail(HttpStatus.UNPROCESSABLE_ENTITY, ex.getMessage());
        problem.setType(URI.create(PROBLEM_BASE_URI + "invalid-project-operation"));
        problem.setTitle("Invalid Project Operation");
        problem.setProperty("timestamp", Instant.now());
        return problem;
    }
