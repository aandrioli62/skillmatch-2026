...
public class GlobalExceptionHandler {
    ...
    public ProblemDetail handleFeedbackNotFound(FeedbackNotFoundException ex) {
        log.warn("Feedback not found: {}", ex.getMessage());
        ProblemDetail problem = ProblemDetail.forStatusAndDetail(HttpStatus.NOT_FOUND, ex.getMessage());
        problem.setType(URI.create(PROBLEM_BASE_URI + "feedback-not-found"));
        problem.setTitle("Feedback Not Found");
        problem.setProperty("timestamp", Instant.now());
        return problem;
    }

    @ExceptionHandler(InvalidFeedbackOperationException.class)
    public ProblemDetail handleInvalidFeedbackOperation(InvalidFeedbackOperationException ex) {
        log.warn("Invalid feedback operation: {}", ex.getMessage());
        ProblemDetail problem = ProblemDetail.forStatusAndDetail(HttpStatus.UNPROCESSABLE_ENTITY, ex.getMessage());
        problem.setType(URI.create(PROBLEM_BASE_URI + "invalid-feedback-operation"));
        problem.setTitle("Invalid Feedback Operation");
        problem.setProperty("timestamp", Instant.now());
        return problem;
    }
